...
print '1) Expected: ',(numTopics, numWords) # TODO: should be numTopics, numWords
assert wordprob.shape == (numTopics, numEmails), 'WordsxTopics matrix shape missmatch'
...
print '2) Expected: ',(numTopics, numWords) # TODO: should be numTopics, numEmails
assert email_prob.shape == (numTopics, numWords), 'DocxTopics matrix shape missmatch'
